...
function useDraggable(target, options = {}) {
  ...
  return __spreadProps$6(__spreadValues$g({}, toRefs2(position)), {
    position,
...
function usePointer(options = {}) {
  ...
  return __spreadProps$22(__spreadValues$6({}, toRefs2(state)), {
    isInside
  });
}
...
var __defProps$92 = Object.defineProperties;
var __getOwnPropDescs$92 = Object.getOwnPropertyDescriptors;
...
var __spreadProps$92 = (a, b) => __defProps$92(a, __getOwnPropDescs$92(b));
var UseDraggable = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const data = reactive(useDraggable(target, __spreadProps$92(__spreadValues$b({}, props), {
      handle,
      initialValue,
      onEnd
    })));
...
function useResizeObserver2(target, callback, options = {}) {
  const _a = options, { window: window2 = defaultWindow2 } = _a, observerOptions = __objRest$12(_a, ["window"]);
  let observer;
  ...
  const targets = computed(
    () => Array.isArray(target) ? target.map((el) => unrefElement2(el)) : [unrefElement2(target)]
  );
  const stopWatch = watch(
    targets,
    (els) => {
...
function useElementVisibility2(element, { window: window2 = defaultWindow2, scrollTarget } = {}) {
  const elementIsVisible = ref(false);
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(useScroll(
    element,
    __spreadProps$72(__spreadValues$8({}, options), {
...
var __getOwnPropSymbols$83 = Object.getOwnPropertySymbols;
var __hasOwnProp$83 = Object.prototype.hasOwnProperty;
var __propIsEnum$83 = Object.prototype.propertyIsEnumerable;
...
var __spreadValues$72 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$83.call(b, prop))
      __defNormalProp$72(a, prop, b[prop]);
  if (__getOwnPropSymbols$83)
    for (var prop of __getOwnPropSymbols$83(b)) {
      if (__propIsEnum$83.call(b, prop))
        __defNormalProp$72(a, prop, b[prop]);
    }
  return a;
};
...
var UseMousePressed = defineComponent({
  ...
  setup(props, { slots }) {
    const target = ref();
    const data = reactive(useMousePressed(__spreadProps$62(__spreadValues$72({}, props), { target })));
    return () => {
      if (slots.default)
        return h(props.as || "div", { ref: target }, slots.default(data));
    };
...
var UseNow = defineComponent({
  ...
  props: ["interval"],
  setup(props, { slots }) {
    const data = reactive(useNow(__spreadProps$5(__spreadValues$62({}, props), { controls: true })));
    return () => {
      if (slots.default)
        return slots.default(data);
    };
...
function useMutationObserver(target, callback, options = {}) {
  const _a = options, { window: window2 = defaultWindow2 } = _a, mutationOptions = __objRest2(_a, ["window"]);
  let observer;
...
var vScroll = {
  [directiveHooks.mounted](el, binding) {
    if (typeof binding.value === "function") {
      ...
      const [handler, options] = binding.value;
      const state = useScroll(el, __spreadProps$23(__spreadValues$3({}, options), {
        onScroll(e) {
          var _a;
...
var UseTimeAgo = defineComponent({
  ...
  setup(props, { slots }) {
    const data = reactive(useTimeAgo(() => props.time, __spreadProps$1(__spreadValues$23({}, props), { controls: true })));
    return () => {
      if (slots.default)
        return slots.default(data);
    };
...
var UseTimestamp = defineComponent({
  ...
  setup(props, { slots }) {
    const data = reactive(useTimestamp(__spreadProps(__spreadValues$12({}, props), { controls: true })));
    return () => {
      if (slots.default)
        return slots.default(data);
    };
